...
x_train =  pd.read_csv("C:\\Users\\pulla\\OneDrive\\Desktop\\thyroid-disease-prediction-100%\\x_train.csv")
y_train =  pd.read_csv("C:\\Users\\pulla\\OneDrive\\Desktop\\thyroid-disease-prediction-100%\\y_train.csv")
logging.info("Read the training data successfully.")

logging.info("Reading testing dataset........")
x_test =  pd.read_csv("C:\\Users\\pulla\\OneDrive\\Desktop\\thyroid-disease-prediction-100%\\x_test.csv")
y_test =  pd.read_csv("C:\\Users\\pulla\\OneDrive\\Desktop\\thyroid-disease-prediction-100%\\y_test.csv")
logging.info("Read the testing data successfully.")

logging.info("Reading validation dataset........")
x_valid =  pd.read_csv("C:\\Users\\pulla\\OneDrive\\Desktop\\thyroid-disease-prediction-100%\\x_valid.csv")
y_valid =  pd.read_csv("C:\\Users\\pulla\\OneDrive\\Desktop\\thyroid-disease-prediction-100%\\y_valid.csv")
